      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-8">
        ...
        <div id="score-hero" className="text-center mb-10 scroll-mt-20">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-900/80 border border-zinc-700/50 text-xs text-zinc-400 font-medium mb-4"
          >
            <span className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse" />
            go viral analysis complete
          </motion.div>
          ...
          <motion.div
            ...
            className="relative max-w-2xl mx-auto rounded-[28px] p-px bg-gradient-to-br from-orange-500/40 via-zinc-800/60 to-pink-500/40 mb-8 shadow-2xl shadow-orange-500/10"
          >
              ...
              {chronicIssues.length > 0 && (
                <div className="mb-6 bg-red-500/5 border border-red-500/20 rounded-2xl p-5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-red-400 font-bold text-sm uppercase tracking-widest">recurring issues</p>
                  </div>
                  <p className="text-sm text-zinc-400 mb-3">These patterns keep showing up. Fix them and you fix more than one video.</p>
