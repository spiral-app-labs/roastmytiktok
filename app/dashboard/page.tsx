      ...
      <div className="min-h-screen bg-[#09090b] pt-14 lg:pt-0 px-6">
        <div className="max-w-2xl mx-auto py-16 lg:py-24">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <EmptyState
              icon={
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-pink-500 shadow-lg shadow-orange-500/20">
                  <Upload className="h-6 w-6 text-white" />
                </div>
              }
              title={userName ? `${userName}, upload your first video` : 'Upload your first video'}
          ...
          <motion.div
            ...
            className="mt-10 bg-[#18181b] border border-zinc-800 rounded-xl p-6 sm:p-8"
            ref={uploadAnchorRef}
          >
            <UploadDropZone />
          </motion.div>
